...
def view():
    ...
    # беру данные из колонок таблицы и вставляю в новую строку с помощью джоина и переношу каждую последующую итерацию на новую строку с помощью тега HTML бр
